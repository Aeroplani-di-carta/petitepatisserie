...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/gaetano.vallarelli/Sites/personal/petitepatisserie/.data/kv"}));
...
const _aQg5snZPuU = (function(nitro) {
...
const handlers = [
  ...
  { route: '/**', handler: _lazy_jqConm, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, isEqual as A, setCookie as B, getCookie as C, deleteCookie as D, handler as E, send as a, setResponseStatus as b, setResponseHeaders as c, useRuntimeConfig as d, eventHandler as e, getQuery as f, getResponseStatus as g, createError$1 as h, getRouteRules as i, joinURL as j, getResponseStatusText as k, klona as l, hasProtocol as m, parseQuery as n, createHooks as o, parseURL as p, isScriptProtocol as q, withTrailingSlash as r, setResponseHeader as s, withoutTrailingSlash as t, useNitroApp as u, sanitizeStatusCode as v, withQuery as w, parse as x, getRequestHeader as y, destr as z };
