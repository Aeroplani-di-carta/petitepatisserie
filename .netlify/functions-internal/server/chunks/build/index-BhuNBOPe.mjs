...
import { _ as __nuxt_component_4 } from './Button-CUVVGIyq.mjs';
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="${ssrRenderClass([{
        hidden: _ctx.slice.variation !== "center",
        "col-start-1 col-end-3 row-start-1 row-end-2": _ctx.slice.variation === "center"
      }, "bg-[radial-gradient(ellipse_at_center,_#0003_0%,#000_90%)] bg-opacity-40 bg-blend-multiply"])}"></div><div class="${ssrRenderClass([{
...
//# sourceMappingURL=index-BhuNBOPe.mjs.map
