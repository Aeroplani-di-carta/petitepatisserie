...
const simplyResolveComponent = (component2) => {
  return resolveDynamicComponent(component2);
};
const usePrismic = () => {
...
const defineSliceZoneComponents = (components) => {
  ...
  for (type in components) {
    const component2 = components[type];
    result[type] = typeof component2 === "string" ? component2 : markRaw(component2);
  }
  return result;
};
  ...
  setup(props) {
    ...
    const renderedSlices = computed(() => {
      return props.slices.map((slice, index) => {
        ...
        let component2 = props.components && type in props.components ? props.components[type] : props.defaultComponent || ((_a = options.components) == null ? void 0 : _a.sliceZoneDefaultComponent) || TODOSliceComponent;
        if (props.resolver) {
        ...
        return h(simplyResolveComponent(component2), p);
      });
    });
    return () => {
      if (props.wrapper) {
...
const createPrismic = (options) => {
  ...
  const prismicHelpers = {
    asText,
    asHTML: (richTextField, ...config2) => {
      const [configOrLinkResolver, maybeHTMLSerializer] = config2;
    ...
    asLink: (linkField, config2) => {
      return asLink(linkField, typeof config2 === "function" ? { linkResolver: config2 } : {
        linkResolver: options.linkResolver,
...
const _yellow = { "50": "#FFFCF5", "100": "#FFF8E6", "200": "#FFF2D1", "300": "#FEEBB8", "400": "#FEE5A4", "500": "#FEDD8C", "600": "#FDC73F", "700": "#E9A702", "800": "#9D7101", "900": "#4C3701", "950": "#281D00", "DEFAULT": "#FEDD8C" };
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BbsEXCHA.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-mpY7PkPJ.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-BEmh_Cr0.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
