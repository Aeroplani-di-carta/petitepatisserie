import { g as getSliceComponentProps, h as PrismicRichText, P as PrismicLink } from './server.mjs';
            ...
            ssrRenderList(_ctx.slice.items, (item, i) => {
              _push2(ssrRenderComponent(unref(Slide), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="relative w-full h-full bg-center bg-cover rounded-md" style="${ssrRenderStyle({ backgroundImage: "url(" + item.image.url + ")" })}"${_scopeId2}>`);
...
//# sourceMappingURL=index-t4EqQEq4.mjs.map
